var constant = {
	...
	ACTION_URL				: 	$('#tradeOrderSideListForm').attr('action'),
	FORM_ID 				: 	"#tradeOrderSideListForm",

	TREE_NAME 				: 	"topologyTree",
    TREE_ID 				: 	"#topologyTree",
    TREE_SELECTED_NODE_ID	: 	"#topologyTreeResultId",
    TREE_ERROR_ID			: 	"#treeError",
    TREE_METHOD_NAME		: 	"/getOrderSideListTree",
    ...
    MULTI_SELECT_ID 		: 	"#side_type_id",
    MULTI_SELECT_METHOD_NAME: 	"/tradeSideTypes",
    MULTI_SELECT_PRIMARY_ID	: 	"side_type_id",
    MULTI_SELECT_PRIMARY_VAL: 	"side_type_name",
    MULTI_SELECT_ERROR_MESSAGE		:	"Please select at least Order Side Type",

    // GET_LIST_METHOD_NAME	: 	"/getOrderTypeList/",
    // GET_LIST_BY_ID_METHOD	: 	"/getOrderTypeListByListID/",
    
    KENDO_GRID_ID			: 	"#orderSideListGrid",
    KENDO_GRID_METHOD		: 	"/getOrderSideList/",
		...
		if (validator.validate()) {
			$.ajax({
				...
				success: function (eventData) {
					...
					$(constant.DROPDOWN_ID).data("kendoComboBox").trigger('change');
				}
			});
		}
	});
