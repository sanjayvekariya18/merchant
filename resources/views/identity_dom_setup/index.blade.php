    ...
    <section class="content p-l-r-15">
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4 class="panel-title">    
                        <i class="fa fa-fw fa-users"></i> Identity dom setup
                    </h4>
                </div>
                <div class="panel-body">
                    <input type="hidden" id="requestUrl" value="{!!url(Request::segment(1))!!}">
                    <div id="identityDomSetupGrid"></div>
                </div>
            </div>
        </div>
    </section>
...
<script type="text/javascript" src="{{asset('assets/kendoui/js/kendo.all.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/custom_js/Identity_dom_setup/Identity_dom_setup.js')}}"></script>
    
    <script id="identityDomSetupHeaderAction" type="text/x-kendo-template">
        <div class="searchToolBar" style="float: right;">
            <label class="search-label" for="searchBox">Search Grid:</label>
            <input type="search" id="identityDomSetupSearchBox" class="k-textbox" style="width: 250px"/>
            <input type="button" id="identityDomSetupBtnSearch" class="k-button" value="Search"/>
            <input type="button" id="identityDomSetupBtnReset" class="k-button" value="Reset"/>
        </div>
    </script>
