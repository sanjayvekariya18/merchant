...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/complex_forms.css')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form class="grid-form">
                    <h2 class="text-center">BANK ACCOUNT OPENING FORM</h2>
                    <fieldset>
                    ...
                    <fieldset>
                        <legend>Personal Details (Sole/First Account holder/Minor)</legend>
                        <div data-row-span="4">
                            <div data-field-span="1">
                                <label>Title</label>
                                <label>
                        ...
                        <div data-row-span="2">
                            <div data-field-span="1">
                                <label>In case of minor please provide details (Name of parent and natural
                                    guardian)
                                </label>
                                <input type="text">
                            </div>
                    ...
                    <br>
                    <fieldset>
                        <legend>Mailing Address (If different from the First Account holder's address)
                        </legend>
                        <div data-row-span="1">
                            <div data-field-span="1">
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('assets/vendors/gridforms/js/gridforms.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/vendors/select2/js/select2.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/custom_js/complex_forms.js')}}" ></script>
