...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="#">Create Exhibitor</a>
        </li>
    </ol>
</section>
<br>
<section class="content">
    <form method = 'POST' enctype="multipart/form-data" class="form-horizontal bv-form" action='{!!url("hase_exhibitor")!!}' id="hase_exhibitor_create">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                               data-loop="true"></i> Create Exhibitor
                        </h3>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="exhibitor_floor" name="exhibitor_floor" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_hall" class="col-sm-3 control-label">Exhibitor Hall</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_hall" name="exhibitor_hall" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_location" class="col-sm-3 control-label">Exhibitor Location</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_location" name="exhibitor_location" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_description" class="col-sm-3 control-label">Exhibitor Description</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_description" name="exhibitor_description" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_contact" class="col-sm-3 control-label">Exhibitor Contact</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_contact" name="exhibitor_contact" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_namecard_url" class="col-sm-3 control-label">Exhibitor Namecard Url</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_namecard_url" name="exhibitor_namecard_url" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_location_map_url" class="col-sm-3 control-label">Exhibitor Location Map Url</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_location_map_url" name="exhibitor_location_map_url" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exhibitor_location_directions" class="col-sm-3 control-label">Exhibitor Location Directions</label>
                            <div class="col-sm-5">
                                <input id="exhibitor_location_directions" name="exhibitor_location_directions" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/HaseExhibitorCreate.js')}}"></script>
