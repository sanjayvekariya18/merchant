...
<section class="content">
    <form id="assetFlowForm" action = '{!!url("asset_flow")!!}/{!!$asset_flow->flow_id!!}/update' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Edit Asset Flow
                        </h3>
                    </div>
                    <div class="panel-body">
                        <input type='hidden' name='_token' value='{{Session::token()}}'>
                        <input type="hidden" name="requestUrl" id="requestUrl" value="{!!url(Request::segment(1))!!}">
                        <input type="hidden" id="h_staff_id" value="{{$asset_flow->staff_id}}">
                                ...
                                <div class="col-sm-4">
                                    <select name="merchant_id" id="merchant_id" class="form-control select21" style="width:100%">
                                        ...
                                        @foreach($merchants as $merchant)
                                           @if($asset_flow->merchant_id == $merchant->merchant_id)
                            ...
                            <div class="col-sm-4">
                                <select name="asset_id" id="asset_id" class="form-control select21" style="width:100%">
                                    ...
                                    @foreach($assets as $asset)
                                       @if($asset_flow->asset_id == $asset->asset_id)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="asset_price_lower" name = "asset_price_lower" type="number" class="form-control" value="{{$asset_flow->asset_price_lower}}" step="0.01">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="asset_price_upper" class="col-sm-3 control-label">Asset Price Upper</label>
                            <div class="col-sm-4">
                                <input id="asset_price_upper" name = "asset_price_upper" type="number" class="form-control" value="{{$asset_flow->asset_price_upper}}" step="0.01">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="asset_quantity_lower" class="col-sm-3 control-label">Asset Quantity Lower</label>
                            <div class="col-sm-4">
                                <input id="asset_quantity_lower" name = "asset_quantity_lower" type="number" class="form-control" value="{{$asset_flow->asset_quantity_lower}}" step="0.01">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="asset_quantity_upper" class="col-sm-3 control-label">Asset Quantity Upper</label>
                            <div class="col-sm-4">
                                <input id="asset_quantity_upper" name = "asset_quantity_upper" type="number" class="form-control" value="{{$asset_flow->asset_quantity_upper}}" step="0.01">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="asset_total_lower" class="col-sm-3 control-label">Asset Total Lower</label>
                            <div class="col-sm-4">
                                <input id="asset_total_lower" name = "asset_total_lower" type="number" class="form-control" value="{{$asset_flow->asset_total_lower}}" step="0.01">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="asset_total_upper" class="col-sm-3 control-label">Asset Total Upper</label>
                            <div class="col-sm-4">
                                <input id="asset_total_upper" name = "asset_total_upper" type="number" class="form-control" value="{{$asset_flow->asset_total_upper}}" step="0.01">
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/AssetFlowEdit.js')}}"></script>
@stop
