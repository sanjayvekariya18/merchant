...
<section class="content-header">
    <h1>Create New Asset Profit & Loss</h1>
    <ol class="breadcrumb">
        <li>
            <a href="index ">
...
<section class="content">
    <form id="assetDealForm"  action = '{!!url("asset_pnl")!!}' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Add Asset Profit & Loss Detail
                        </h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4" style="padding-left: 15px;padding-right: 15px;">
                                    <input id="pnl_date" name="pnl_date" type="text" value="<?= date('Y-m-d') ?>" class="form-control pull-left" data-language='en' /> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="trade_fees" name = "trade_fees" type="number" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="quantity_closed" class="col-sm-3 control-label">Quantity Closed</label>
                            <div class="col-sm-4">
                                <input id="quantity_closed" name = "quantity_closed" type="number" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="quantity_open" class="col-sm-3 control-label">Quantity Open</label>
                            <div class="col-sm-4">
                                <input id="quantity_open" name = "quantity_open" type="number" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="position_unrealized" class="col-sm-3 control-label">Unrealized</label>
                            <div class="col-sm-4">
                                <input id="position_unrealized" name = "position_unrealized" type="number" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="pnl_margin" class="col-sm-3 control-label">Margin</label>
                            <div class="col-sm-4">
                                <input id="pnl_margin" name = "pnl_margin" type="number" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="pnl_balance_remaining" class="col-sm-3 control-label">Balance Remaining</label>
                            <div class="col-sm-4">
                                <input id="pnl_balance_remaining" name = "pnl_balance_remaining" type="number" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="trade_long" class="col-sm-3 control-label">Long</label>
                            <div class="col-sm-4">
                                <input id="trade_long" name = "trade_long" type="number" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="trade_short" class="col-sm-3 control-label">Short</label>
                            <div class="col-sm-4">
                                <input id="trade_short" name = "trade_short" type="number" class="form-control">
                            </div>
                        </div> 
                    </div>
                </div>
