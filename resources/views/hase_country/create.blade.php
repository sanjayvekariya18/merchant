...
<section class="content">
    ...
    <form id="countryForm"  action = '{!!url("hase_country")!!}' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">                        
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="iso_code_2" name = "iso_code_2" type="text" class="form-control" maxlength="2"> 
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="iso_code_3" class="col-sm-3 ">ISO Code 3</label>
                            <div class="col-sm-8">
                                <input id="iso_code_3" name = "iso_code_3" type="text" class="form-control" maxlength="3">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="country_phone_code" name = "country_phone_code" type="text" class="form-control">
                            </div> 
                        </div>
                        <div class="form-group">
                            <label for="telephone_min" class="col-sm-3 ">Telephone Min</label>
                            <div class="col-sm-8">
                                <input id="telephone_min" name = "telephone_min" type="number" class="form-control"> 
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="telephone_max" class="col-sm-3 ">Telephone Max</label>
                            <div class="col-sm-8">
                                <input id="telephone_max" name = "telephone_max" type="number" class="form-control"> 
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="CountryFlag" class="col-sm-3">
                                Country Flag
