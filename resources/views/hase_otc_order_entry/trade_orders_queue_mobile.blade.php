      ...
      <div class="panel panel-primary">
         ...
         <div class="panel-body">
            <?php if(!isset($retry)){ 
               ...
               <input type="hidden" id="orderId" value="{!!$tradeOrdersQueueListDataValue->order_id!!}" />
           ...
           .kendoGrid({
               ...
               dataBound: function(e) {
                   ...
                   $.each(data, function (i, row) {
                       ...
                       } else if(assetPriceLower > 0 && parseFloat($('tr[data-uid="' + row.uid + '"] td:nth-child(2)').html()) > assetPriceLower)
                       {
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(2)').css("background-color", "lightgreen");
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(3)').css("background-color", "lightgreen");
                       } else if(assetPriceUpper > 0 && parseFloat($('tr[data-uid="' + row.uid + '"] td:nth-child(3)').html()) < assetPriceUpper)
                       {
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(2)').css("background-color", "lightgreen");
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(3)').css("background-color", "lightgreen");
                       } else {
                       ...
                       } else if(assetQuantityLower > 0 && parseFloat($('tr[data-uid="' + row.uid + '"] td:nth-child(4)').html()) > assetQuantityLower)
                       {
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(4)').css("background-color", "lightgreen");
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(5)').css("background-color", "lightgreen");
                       } else if(assetQuantityUpper > 0 && parseFloat($('tr[data-uid="' + row.uid + '"] td:nth-child(5)').html()) < assetQuantityUpper)
                       {
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(4)').css("background-color", "lightgreen");
                           $('tr[data-uid="' + row.uid + '"] td:nth-child(5)').css("background-color", "lightgreen");
                       } else {
