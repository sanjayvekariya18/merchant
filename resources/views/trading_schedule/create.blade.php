...
<section class="content-header">
    <h1>Create New Trading Schedule</h1>
    <ol class="breadcrumb">
        <li>
            <a href="index ">
...
<section class="content">
    <form id="tradingScheduleForm"  action = '{!!url("trading_schedule")!!}' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Add Trading Schedule
                        </h3>
                    </div>
