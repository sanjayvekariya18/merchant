                                                ...
                                                <div class="timeline-heading">
                                                    ...
                                                    <span class="text-danger">
                                                        <span style="font-size:15px;font-weight: bold;">
                                                            <?php                                              
                                                            echo date('m/d/Y h:i A',strtotime($hase_activity->date_added))." ".Config::get('app.timezone').($hase_activity->user_timezone !="" ? " [".$hase_activity->user_time. " ".$hase_activity->user_timezone.']' : ""); 
