            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4 class="panel-title">    
                        <i class="fa fa-fw fa-users"></i> Portal exception
                    </h4>
                </div>
                <div class="panel-body">
                    <input type="hidden" id="requestUrl" value="{!!url(Request::segment(1))!!}">
                    <div id="Portal_exceptionGrid"></div>
                </div>
            </div>
        </div>
    </section>
...
<script type="text/javascript" src="{{asset('assets/kendoui/js/kendo.all.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/js/custom_js/Portal_exception/Portal_exception.js')}}"></script>
    <script id="Portal_exceptionSearch" type="text/x-kendo-template">
        <div class="searchToolBar" style="float: right;">
            <label class="search-label" for="searchBox">Search Grid:</label>
            <input type="search" id="Portal_exceptionSearchBox" class="k-textbox" style="width: 250px"/>
            <input type="button" id="Portal_exceptionBtnSearch" class="k-button" value="Search"/>
            <input type="button" id="Portal_exceptionBtnReset" class="k-button" value="Reset"/>
        </div>
    </script>
