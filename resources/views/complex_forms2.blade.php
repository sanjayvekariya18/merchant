...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/custom_css/complex_forms2.css')}}" />
                    ...
                    <form class="grid-form form-horizontal">
                        ...
                        <fieldset>
                            ...
                            <div data-row-span="4">
                                <div data-field-span="3">
                                    <label>Please open my</label>
                                    <label>
                                        <input type="radio" name="customer-title[]"> Savings Account</label> &nbsp;
                                    <label>
                                        <input type="radio" name="customer-title[]"> Savings Salary Account
                                    </label>
                                </div>
                        ...
                        <fieldset>
                            ...
                            <div data-row-span="4">
                                ...
                                <div data-field-span="1">
                                    ...
                                    <input type="radio" id="mode1" name="optionsRadios4" class="square-blue">
                                    <label for="mode1">Cash</label>
                                    <input type="radio" id="mode2" name="optionsRadios4" class="square-blue">&nbsp;
                                    <label for="mode2">Cheque</label>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <div data-row-span="1">
                            <div data-field-span="1">
                                ...
                                <label>
                                    <input type="radio" name="optionsRadios5" class="square-blue">&nbsp;Either/Any one or
                                    Survivor
                                </label>
                                <label>
                        ...
                        <fieldset>
                            ...
                            <div data-row-span="18">
                                <div data-field-span="3">
                                    ...
                                    <label for="income_below50"><i class="fa fa-angle-left" aria-hidden="true"></i>
                                        50,000</label>
                                </div>
                                <div data-field-span="3">
                                ...
                                <div data-field-span="3">
                                    ...
                                    <label for="income_above15l"><i class="fa fa-angle-right" aria-hidden="true"></i>15,00,000</label>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('assets/js/custom_js/complex_form2.js')}}"></script>
