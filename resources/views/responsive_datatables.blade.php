            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-paragraph"></i> DOM Positioning
                            </h3>
                        </div>
                        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-th-large"></i> Multiple Controls
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-danger filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-table"></i> With Mark.js Gobal Search
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
