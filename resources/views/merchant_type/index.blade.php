...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="active">Merchant Type</a></li>
        </ol>
    </section>
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/merchantType.js')}}"></script>
@stop
