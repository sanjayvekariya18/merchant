...
<section class="content">
    <form id="assetDealForm"  action = '{!!url("asset_risk")!!}' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Add Asset Risk Detail
                        </h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4" style="padding-left: 15px;padding-right: 15px;">
                                    <input id="risk_date" name="risk_date" type="text" value="<?= date('Y-m-d') ?>" class="form-control pull-left" data-language='en' /> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="asset_price_average" name = "asset_price_average" type="number" class="form-control">
                            </div>
                        </div>                        
                    </div>
                </div>
