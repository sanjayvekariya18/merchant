...
<section class="content">
    <form method = 'POST' enctype="multipart/form-data" class="form-horizontal bv-form" action='{!!url("hase_approval_group_list")!!}' id="create_approval_group_form">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                               data-loop="true"></i> Create Approval Routing
                        </h3>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="target_staff_group_id" id="target_staff_group_id" class = "form-control select21">
                                    @foreach($hase_staff_groups as $hase_staff_group)
                                        <option value="{{$hase_staff_group->group_id}}">{{$hase_staff_group->group_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="source_approval_status_id" id="source_approval_status_id" class = "form-control select21">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select name="target_approval_status_id" id="target_approval_status_id" class = "form-control select21">
                                    @foreach($hase_approval_statuses as $hase_approval_status)
                                        <option value="{{$hase_approval_status->approval_status_id}}">{{$hase_approval_status->approval_status_name}}</option>
                                    @endforeach
                                </select>
