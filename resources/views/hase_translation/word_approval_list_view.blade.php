...
<!--page level css -->
    ...
    <style>
        ...
        #wordApprovalGrid table tr th,
        #wordApprovalGrid table tr td{
            width: 33%;
        }
...
<section class="content-header">
    <h1>Word Approval List</h1>
    <ol class="breadcrumb">
        <li><a href="index "><i class="fa fa-fw fa-home"></i> Dashboard</a></li>
        <li><a href="#"> Word Approval List</a></li>
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                               data-loop="true"></i> Word Approval List
                        </h3>
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/WordApprovalView.js')}}"></script>
@stop