...
<!--page level css -->
    ...
    <style>
        ...
        #imageApprovalGrid table tr th,
        #imageApprovalGrid table tr td{
            width: 33%;
        }
...
<section class="content-header">
    <h1>Image Approval List</h1>
    <ol class="breadcrumb">
        <li><a href="index "><i class="fa fa-fw fa-home"></i> Dashboard</a></li>
        <li><a href="#"> Image Approval List</a></li>
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                               data-loop="true"></i> Image Approval List
                        </h3>
                        <input type="hidden" id="requestUrl" value="{!!url(Request::segment(1))!!}">

                    </div>
                    <div class="panel-body">
                    <div id="imageApprovalGrid"></div>
        </div>
    </section>
</section>
@endsection
...
<img src="#=image_url#" style="width: 80px; height: 40px;"/>
</script>
<script type="text/javascript" src="{{asset('assets/js/custom_js/ImageApprovalView.js')}}"></script>
@stop