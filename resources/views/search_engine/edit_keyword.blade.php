                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                               data-loop="true"></i> Edit Keywords
                        </h3>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                           <label for="keyword" class="col-sm-1 control-label"><b>Keyword</b></label>
                                <div class="col-sm-5">                               
                                    <input id="keyword" name="keyword" value="{{$keywordData->keyword}}" type="text" class="form-control required">
                                </div>
                        </div>
                        <div class="form-group">
                                <div class="col-sm-5">                               
                        ...
                        <button type="button" class="btn btn-success" id="saveStyle" onclick="setRegionActivityValue('../../update_keyword',{{$keywordData->keyword_id}})" ><span class="glyphicon glyphicon-ok-sign"></span> Save</button>&nbsp &nbsp &nbsp<button type="button" class="btn btn-success" id="saveStyle" onclick='javascript:goBack()' ><span class="glyphicon glyphicon-ok-sign"></span> Cancel </button><br><br>

                         <p><b>Activity </b>: <?php if(isset($treeData['activityName'])){echo  $treeData['activityName'];} ?></p>
                         <p><b>Region </b>: <?php if(isset($treeData['regionName'])){echo  $treeData['regionName'];}?></p>                   
