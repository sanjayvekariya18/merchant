                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="connector_key" name="connector_key" type="text" class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="connector_passcode" class="col-sm-3 control-label">Connector Passcode</label>
                            <div class="col-sm-4">
                                <input id="connector_passcode" name="connector_passcode" type="text" class="form-control">
                            </div>
                        </div> 
                    </div>
                </div>
...
<script type="text/javascript" src="{{asset('assets/vendors/select2/js/select2.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/custom_js/SocialApikeysCreate.js')}}"></script>
@stop