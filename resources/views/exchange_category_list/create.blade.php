...
<section class="content-header">
    <h1>Create New Exchange Category List</h1>
    <ol class="breadcrumb">
        <li>
            <a href="index ">
...
<section class="content">
    <form id="assetForm"  action = '{!!url("exchange_category_list")!!}' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <!-- <button type="submit" name="submitBtn" value="Save" class='btn btn-primary btn-inline'>Save</button> -->
                <button type="submit" name="submitBtn" value="SaveClose" class = 'btn btn-primary btn-inline'>Save  &amp; close</button>
                <a href="{!!url("exchange_category_list")!!}" class='btn btn-primary btn-inline'>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Add Exchange Category List Detail
                        </h3>
                    </div>
...
<script type="text/javascript" src="{{asset('assets/vendors/select2/js/select2.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/custom_js/ExchangeCategoryListCreate.js')}}"></script>
@stop