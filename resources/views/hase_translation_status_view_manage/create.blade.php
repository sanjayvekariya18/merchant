...
{{-- Page title --}}
@section('title')
    Create Translation Status View Manage
    @parent
@stop
{{-- page level styles --}}
...
<section class="content-header">
    <h1>Create Translation Status View Manage</h1>
    <ol class="breadcrumb">
        <li>
            <a href="index ">
...
<section class="content">
    <form method = 'POST' enctype="multipart/form-data" class="form-horizontal bv-form" action = '{!!url("hase_status_view_manage")!!}' id="create_hase_translation_statis_view_manage_form">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                               data-loop="true"></i> Create Translation status View Manage
                        </h3>
