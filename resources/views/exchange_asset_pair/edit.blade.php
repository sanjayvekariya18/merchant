...
<section class="content-header">
    <h1>Edit Exchange Asset Pair</h1>
    <ol class="breadcrumb">
        <li>
            <a href="index ">
...
<section class="content">
    <form id="exchangeAssetPairForm"  action='{!!url("exchange_asset_pair")!!}/{!!$exchange_asset_pair->pairs_id!!}/update' method='POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Edit Exchange Asset Pair
                        </h3>
                    </div>
                    <div class="panel-body">
                            ...
                            <div class="col-sm-4">
                                <select name="exchange_id" id="exchange_id" class="form-control select21" style="width:100%">
                                    ...
                                    @foreach($exchanges as $exchange)
                                        @if($exchange_asset_pair->exchange_id == $exchange->exchange_id)
                            ...
                            <div class="col-sm-4">
                                <select name="asset_from_id" id="asset_from_id" class="select21 form-control required">
                                    ...
                                    @foreach($assets as $asset)
                                        @if($asset->asset_id == $exchange_asset_pair->asset_from_id)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="asset_into_id" id="asset_into_id" class="select21 form-control required">
                                    <option></option>
                                    @foreach($assets as $asset)
                                        @if($asset->asset_id == $exchange_asset_pair->asset_into_id)
                                            <option value="{{$asset->asset_id}}" selected>{{$asset->identity_code}}</option>
                                        @else
                                            <option value="{{$asset->asset_id}}">{{$asset->identity_code}}</option>
                                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="priority" name="priority" type="number" value="{!!$exchange_asset_pair->priority!!}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="make-switch" data-on="danger" data-off="default">
                                    <input id="enable" name="enable" value="{!!$exchange_asset_pair->enable!!}" type="checkbox" checked="" />
                                </div>
                            </div>
                        </div>
                    </div>
