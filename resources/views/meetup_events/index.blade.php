            ...
            @if($tokenData)
                <?php if (in_array("add", $permissions)): ?>
                    <div class="syncGroupListDiv">
                        <button type="button" id="getGroupList" name="submitBtn" class="send-btn k-button">Get Meetup Groups</button><br>
                    </div>
                <?php endif;?>
            @else
                <div class="note note-danger">
                    <i class="fa fa-warning fa-2x pull-left"></i>
                    <span>Please login to <a id="meetupLoginRedirect" href='#'>Meetup</a>.</span>
                </div>
            @endif
        </div>
    </div>
    ...
    <section class="content p-l-r-15">
        <div class="row">
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <i class="fa fa-fw fa-users"></i> Meetup Groups
                    </h4>
                </div>
                <div>
                    <div class="panel-body meetupUnSyncPanel">
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <i class="fa fa-fw fa-users"></i> Meetup Events
                    </h4>
                </div>
                <div class="panel-body eventListPanel">
                        <div id="meetupGroupDetails" class="eventListGridPanel"></div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('assets/js/custom_js/Meetup/meetupEvents.js')}}"></script>
    <script type="text/x-kendo-template" id="templateDetail">
        <div class="meetupEventDetails"></div>
    </script>
    ...
    <script id="meetupGridSearch" type="text/x-kendo-template">
          <label class="search-label" for="searchBox">Search Grid:</label>
          <input type="search" id="meetupSearchBox" class="k-textbox" style="width: 250px"/>
          <input type="button" id="meetupBtnSearch" class="k-button" value="Search"/>
          <input type="button" id="meetupBtnReset" class="k-button" value="Reset"/>
    </script>
