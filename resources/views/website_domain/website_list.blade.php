...
@section('header_styles')
    ...
    <style>
        ...
        #websiteDomainListGrid table tr th,
        #websiteDomainListGrid table tr td{
            width: 33%;
        }
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h4 class="panel-title">    
                        <i class="fa fa-fw fa-users"></i> Website Domain List
                    </h4>
                     <input type="hidden" id="requestUrl" value="{!!url(Request::segment(1))!!}">
                     <input type="hidden" id="request_url" value="{{url('website_domain_list')}}">
                </div>
                <div class="panel-body">         
                   <div id="websiteDomainListGrid"></div>
                </div>
            </div>
        </div>
    </section>    
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/WebsiteDomainList.js')}}"></script>
