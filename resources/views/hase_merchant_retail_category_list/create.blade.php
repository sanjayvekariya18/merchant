...
<section class="content">
    ...
    <form id="CategoriesForm"  action = '{!!url("hase_category_list")!!}' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <!-- <button type="submit" name="submitBtn" value="Save" class='btn btn-primary btn-inline'>Save</button> -->
                <button type="submit" name="submitBtn" value="SaveClose" class = 'btn btn-primary btn-inline'>Save  &amp; close</button>
                <a href="{!!url('hase_category_list')!!}" class='btn btn-primary btn-inline'>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Assign Categories
                        </h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <!-- <div class="form-group">
                            <label for="category_priority" class="col-sm-3">Priority</label>
                            <div class="col-sm-8">
                                <input id="category_priority" name="category_priority" type="number" class="form-control" min="0" value="0" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="category_status" class="col-sm-3">Status</label>
                            <div class="col-sm-8">
                                <input id="category_status" name="category_status" type="checkbox" data-on-text="Enabled" data-on-color="success" data-off-color="danger" data-off-text="Disabled" />
                            </div>
                        </div> -->
                        <div class="row">
                            <div class="col-md-12">
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/HaseCategoryListCreate.js')}}"></script>
@stop