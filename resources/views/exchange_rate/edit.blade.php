...
<section class="content-header">
    <h1>Edit Exchange Asset Rate</h1>
    <ol class="breadcrumb">
        <li>
            <a href="index ">
...
<section class="content">
    <form id="assetForm"  action = '{!! url("exchange_rates")!!}/{!!$exchange_rate->
        rate_id!!}/update' method = 'POST' class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="fa fa-fw fa-crosshairs"></i> Edit Exchange Asset Rate Detail
                        </h3>
                    </div>
                    <div class="panel-body">
                            ...
                            <div class="col-sm-4">
                                <select name="exchange_id" id="exchange_id" class="form-control select21" style="width:100%">
                                    ...
                                    @foreach($exchanges as $exchange)
                                        @if($exchange_rate->exchange_id == $exchange->exchange_id)
                            ...
                            <div class="col-sm-4">
                                <select name="base_currency_id" id="base_currency_id" class="form-control select21" style="width:100%">
                                    ...
                                    @foreach($assets as $asset)
                                        @if($exchange_rate->base_currency_id == $asset->asset_id)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="quote_currency_id" id="quote_currency_id" class="form-control select21" style="width:100%">
                                    <option></option>
                                    @foreach($assets as $asset)
                                        @if($exchange_rate->quote_currency_id == $asset->asset_id)
                                            <option value="{{$asset->asset_id}}" selected="">{{$asset->asset_name}}</option>
                                        @else
                                            <option value="{{$asset->asset_id}}">{{$asset->asset_name}}</option>
                                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="volume_currency_id" id="volume_currency_id" class="form-control select21" style="width:100%">
                                    <option></option>
                                    @foreach($assets as $asset)
                                        @if($exchange_rate->volume_currency_id == $asset->asset_id)
                                            <option value="{{$asset->asset_id}}" selected="">{{$asset->asset_name}}</option>
                                        @else
                                            <option value="{{$asset->asset_id}}">{{$asset->asset_name}}</option>
                                        @endif    
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="level_margin_call" name = "level_margin_call" type="text" class="form-control" value='{!!$exchange_rate->level_margin_call!!}'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="level_margin_liquidation" class="col-sm-3 control-label">Level Margin Liquidation</label>
                            <div class="col-sm-4">
                                <input id="level_margin_liquidation" name = "level_margin_liquidation" type="text" class="form-control" value='{!!$exchange_rate->level_margin_liquidation!!}'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="leverage_buy" class="col-sm-3 control-label">Leverage Buy</label>
                            <div class="col-sm-4">
                                <input id="leverage_buy" name = "leverage_buy" type="text" class="form-control" value='{!!$exchange_rate->leverage_buy!!}'>
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="leverage_sell" class="col-sm-3 control-label">Leverage Sell</label>
                            <div class="col-sm-4">
                                <input id="leverage_sell" name = "leverage_sell" type="text" class="form-control" value='{!!$exchange_rate->leverage_sell!!}'>
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="margin_percent" class="col-sm-3 control-label">Margin Percent</label>
                            <div class="col-sm-4">
                                <input id="margin_percent" name = "margin_percent" type="text" class="form-control" value='{!!$exchange_rate->margin_percent!!}'>
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4" style="padding-left: 15px;padding-right: 15px;">
                                    <input id="funding_start" name="funding_start" type="text" value="<?php if($exchange_rate->funding_start != 0) { echo substr_replace(substr_replace($exchange_rate->funding_start, '-', 4, 0), '-', 7, 0); } else { echo '';}?>" class="form-control pull-left" data-language='en' /> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="funding_interval" name = "funding_interval" type="text" class="form-control" value='{!!$exchange_rate->funding_interval!!}'>
                            </div>
                        </div> 
                        <div class="form-group">
                            <label for="funding_rate" class="col-sm-3 control-label">Funding Rate</label>
                            <div class="col-sm-4">
                                <input id="funding_rate" name = "funding_rate" type="text" class="form-control" value='{!!$exchange_rate->funding_rate!!}'>
                            </div>
                        </div>                      
                    </div>
                </div>
...
<script type="text/javascript" src="{{asset('assets/vendors/select2/js/select2.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/custom_js/ExchangeRateEdit.js')}}"></script>
@stop