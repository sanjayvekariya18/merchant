            ...
            <div class="panel panel-primary ">
                <div class="panel-heading">
                    <h4 class="panel-title">    
                        <i class="fa fa-fw fa-users"></i> Translation Manage List
                    </h4>
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/TranslationManageList.js')}}"></script>
