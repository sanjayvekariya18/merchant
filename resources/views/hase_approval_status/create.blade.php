...
<section class="content">
    <form method = 'POST' enctype="multipart/form-data" class="form-horizontal bv-form" action='{!!url("hase_approval_status")!!}' id="approval_status">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="approval_status_code" class="col-sm-3 control-label">Status Code</label>
                            <div class="col-sm-5">
                                <input id="approval_status_code" name="approval_status_code" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="approval_status_name" class="col-sm-3 control-label">Status Name</label>
                            <div class="col-sm-5">
                                <input id="approval_status_name" name="approval_status_name" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="approval_status_display" class="col-sm-3 control-label">Status Display</label>
                            <div class="col-sm-5">
                                <input class="switch form-control" data-on-color="success" data-off-color="danger" data-on-text="Enabled" data-off-text="Disabled" id="approval_status_display" name="approval_status_display" type="checkbox" value="1" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="approval_status_color" class="col-sm-3 control-label">Status Color</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control my-colorpicker1" id="approval_status_color" name="approval_status_color">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="approval_status_font_color" class="col-sm-3 control-label">Status Font Color</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control my-colorpicker1" id="approval_status_font_color" name="approval_status_font_color">
                            </div>
                        </div>
                    </div>
                </div>
