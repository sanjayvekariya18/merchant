...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/custom_css/fontawesome_icons.css')}}">
                            ...
                            <section id="directional">
                                ...
                                <div class="row fontawesome-icon-list">
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="col-md-2 col-sm-4 fa-icon">
                                            <i class="fa fa-fw fa-chevron-up clickable"></i> fa-chevron-up
                                        </div>
                                        <div class="col-md-2 col-sm-4 fa-icon">
...
<script type="text/javascript" src="{{asset('assets/js/custom_js/fontawesome_icons.js')}}" ></script>
