...
elixir(function (mix) {
    ...
    // //isotope
    // mix.copy(paths.isotope + 'jquery.quicknote.css', destVendors + 'quicknote-jquery/css');
    ...
    //sass compilation
    mix.sass('bootstrap/bootstrap.scss', destCss + 'bootstrap.css');
    mix.sass('buttons/buttons.scss', destCss + 'buttons_sass.css');
    mix.sass('custom.scss', destCss + 'custom.css');
