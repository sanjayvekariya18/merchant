 ...
 */
class TradeLimitsController extends PermissionsController
{
    use PermissionTrait;
    ...
    public function __construct()
    {
        ...
        $connectionStatus = ConnectionManager::setDbConfig('Trade_limits_view');
     ...
     */
    public function TradeLimitsIndex()
    {
        $title = 'Index - position';
        return view('trade_limits.tradeLimitsIndex',compact('title'));
    }
    ...
    public function RetrieveTradeLimitsList($filterValue) { 
        ...
        $tradeLimitListData = Trade_limits::select(
                        'trade_limits.*',
                        ...
                        ->leftjoin('location_city','location_city.city_id','trade_limits.location_city_id')

                        ->leftjoin('staffs','staffs.staff_id','trade_limits.staff_id')

                        ->leftjoin('staff_groups','staff_groups.staff_group_id','trade_limits.group_id')
                        ...
                        ->leftjoin('account','account.account_id','trade_limits.staff_account_id')

                        // ->leftjoin('identity as account_identity','account_identity.identity_id','account.identity_id')

                        ->leftjoin('asset as asset_into','asset_into.asset_id','trade_limits.asset_id')
        ...
        return $tradeLimitListData->toArray();
    }
}
